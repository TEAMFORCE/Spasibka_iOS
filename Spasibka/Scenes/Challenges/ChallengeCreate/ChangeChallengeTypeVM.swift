//
//  ChangeChallengeTypeVM.swift
//  Spasibka
//
//  Created by Yerzhan Gapurinov on 13.12.2022.
//

import Foundation
import StackNinja

final class ChangeChallengeTypeVM<Design: DSP>: StackModel, Designable {
   //
...
extension ChangeChallengeTypeVM: SetupProtocol {
...
extension ChangeChallengeTypeVM: Eventable {
